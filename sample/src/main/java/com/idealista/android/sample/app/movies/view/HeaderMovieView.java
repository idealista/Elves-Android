...
public class HeaderMovieView extends LinearView<Void> {

    private TextView textViewTitle;
    private OnClicked<Void> onClicked;

    public HeaderMovieView(Context context) {
        super(context);
    }

    public HeaderMovieView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public HeaderMovieView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public HeaderMovieView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void prepare() {
        ...
        textViewTitle.setText("Header ** Idealista **");
    }
